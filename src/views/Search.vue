<template>
    <div>
        ...
        <div v-show="!getPaginationLoading">
            ...
            <input id="bird" v-model="animalType" type="radio" value="bird" />
            Bird
            <input
                id="rodent"
                v-model="animalType"
            ...
            <br />
            <br />
            <input v-model="filters" value="vaccinated" type="checkbox" />
            Vaccinated
            <input v-model="filters" value="chipped" type="checkbox" /> Chipped
            <input v-model="filters" value="sterilized" type="checkbox" />
            Sterilized
            <hr />
            <div v-for="(ad, index) in filteredData" :key="index + '-a'">
                ...
                >
                    ...
                    Name: {{ ad.name }}, vaccinated: {{ ad.vaccinated }},
                    sterilized: {{ ad.sterilized }}, chipped:
                    {{ ad.chipped }}
                </router-link>
            </div>
